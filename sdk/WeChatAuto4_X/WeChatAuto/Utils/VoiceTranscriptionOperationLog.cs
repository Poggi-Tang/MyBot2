...
{
    internal static class VoiceTranscriptionOperationLog
    {
            ...
            Dictionary<string, object> details = null)
        {
            try
            {
                ...
                lock (Sync)
                {
                    ...
                    var path = Path.Combine(directory, $"voice-transcription-{DateTime.Now:yyyyMMdd}.jsonl");
