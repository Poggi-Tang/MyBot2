...
builder.Services.Configure<WeChatWindowWatchdogOptions>(
    builder.Configuration.GetSection(WeChatWindowWatchdogOptions.SectionName));
builder.Services.AddHostedService<WeChatWindowWatchdog>();
